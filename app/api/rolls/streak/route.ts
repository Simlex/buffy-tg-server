...
import { updateUserDailyRollStreak } from "../../services/rollsService";
...
export async function POST(req: NextRequest) {
  ...
  try {
    // Call the update user daily roll streak function
    const operation = await updateUserDailyRollStreak(req);
